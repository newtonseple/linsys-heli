...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* S-Function Block: heli_q8/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_Sum_k = heli_q8_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
  }
  ...
  rtb_Frontgain = heli_q8_X.Integrator_CSTATE;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S8>/Add2' incorporates:
     *  Constant: '<S8>/Constant2'
     */
    heli_q8_B.Add2 = rtb_Sum_k + heli_q8_P.Constant2_Value;
    ...
    /* Gain: '<S12>/Gain' */
    heli_q8_B.Gain = heli_q8_P.Gain_Gain * heli_q8_B.ElevationCounttorad;

    /* Sum: '<S7>/Sum' incorporates:
     *  Constant: '<Root>/Constant1'
     *  Gain: '<S6>/Gain1'
     */
    rtb_Sum_k = heli_q8_P.Constant1_Value - heli_q8_P.Gain1_Gain *
      heli_q8_B.Gain;

    /* Gain: '<S11>/K_ep' */
    heli_q8_B.K_ep = heli_q8_P.K_ep_Gain * rtb_Sum_k;
  }

  /* Gain: '<S13>/Gain' incorporates:
   *  TransferFcn: '<S8>/Elevation: Transfer Fcn'
   */
  heli_q8_B.Gain_d = (heli_q8_P.ElevationTransferFcn_C *
   ...
   *  Sum: '<S11>/Sum'
   */
  rtb_Backgain = ((rtb_Frontgain + heli_q8_B.K_ep) - heli_q8_P.Gain1_Gain_k *
                  heli_q8_B.Gain_d * heli_q8_P.K_ed_Gain) + -heli_q8_P.L_2 /
    heli_q8_P.L_3;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<S10>/  ' incorporates:
     *  Gain: '<S2>/Gain1'
     */
    heli_q8_B.u = heli_q8_B.Gain2 - heli_q8_P.Gain1_Gain_o * heli_q8_B.Gain_i;

    /* Gain: '<S10>/Kpp ' */
    heli_q8_B.Kpp = heli_q8_P.Kpp * heli_q8_B.u;
  }
  ...
  rtb_Frontgain = 0.0;
  rtb_Frontgain += heli_q8_P.PitchTransferFcn_C *
    heli_q8_X.PitchTransferFcn_CSTATE;
  rtb_Frontgain += heli_q8_P.PitchTransferFcn_D * heli_q8_B.PitchCounttorad;

  /* Gain: '<S15>/Gain' */
  heli_q8_B.Gain_b = heli_q8_P.Gain_Gain_ae * rtb_Frontgain;

  /* Sum: '<S10>/   	' incorporates:
   *  Gain: '<S10>/Kpd'
   *  Gain: '<S3>/Gain1'
   */
  heli_q8_B.u_j = heli_q8_B.Kpp - heli_q8_P.Gain1_Gain_i * heli_q8_B.Gain_b *
    heli_q8_P.Kpd;

  /* Gain: '<S1>/Front gain' incorporates:
   *  Sum: '<S1>/Add'
   */
  rtb_Frontgain = (heli_q8_B.u_j + rtb_Backgain) * heli_q8_P.Frontgain_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S11>/K_ei' */
    heli_q8_B.K_ei = heli_q8_P.K_ei_Gain * rtb_Sum_k;
   ...
   */
  heli_q8_B.Gain_dc = (heli_q8_P.TravelTransferFcn_C *
                       heli_q8_X.TravelTransferFcn_CSTATE +
                       heli_q8_P.TravelTransferFcn_D *
                       heli_q8_B.TravelCounttorad) * heli_q8_P.Gain_Gain_l;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S16>/Gain' */
    heli_q8_B.Gain_p = heli_q8_P.Gain_Gain_ar * heli_q8_B.TravelCounttorad;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Backgain = (rtb_Backgain - heli_q8_B.u_j) * heli_q8_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      tmp = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      tmp = 0.0;
    } else {
      tmp = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S9>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * tmp *
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3240223152U);
  heli_q8_M->Sizes.checksums[1] = (2398972375U);
  heli_q8_M->Sizes.checksums[2] = (1489192030U);
  heli_q8_M->Sizes.checksums[3] = (3102024970U);
...

  {
    ...
    heli_q8_B.Gain_dc = 0.0;
    heli_q8_B.Gain_p = 0.0;
  ...
  heli_q8_M->Sizes.numBlocks = (67);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (26);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (160);/* Sum of parameter "widths" */
  return heli_q8_M;
}
