 ...
 * C source code generated on : Thu Oct 20 18:09:29 2016
 *
...
typedef struct {
  ...
  real_T Gain_i;                       /* '<S14>/Gain' */
  real_T u;                            /* '<S10>/  ' */
  real_T Kpp;                          /* '<S10>/Kpp ' */
  real_T Gain_b;                       /* '<S15>/Gain' */
  real_T u_j;                          /* '<S10>/   	' */
  real_T K_ei;                         /* '<S11>/K_ei' */
  real_T Add;                          /* '<S8>/Add' */
  real_T TravelCounttorad;             /* '<S8>/Travel: Count to rad' */
  real_T Gain_dc;                      /* '<S17>/Gain' */
  real_T Gain_p;                       /* '<S16>/Gain' */
...
struct P_heli_q8_T_ {
  ...
  real_T Kpd;                          /* Variable: Kpd
                                        * Referenced by: '<S10>/Kpd'
                                        */
  real_T Kpp;                          /* Variable: Kpp
                                        * Referenced by: '<S10>/Kpp '
                                        */
  ...
  real_T Gain2_Gain;                   /* Expression: -1
                                        ...
                                        */
  real_T Constant1_Value_p;            /* Expression: -19
 ...
 * '<S11>'  : 'heli_q8/Elevation controller/Elevation controller'
 * '<S12>'  : 'heli_q8/Heli 3D/Elevation rad to deg'
 * '<S13>'  : 'heli_q8/Heli 3D/Elevation rate rad to deg'
 * '<S14>'  : 'heli_q8/Heli 3D/Pitch rad to deg'
 * '<S15>'  : 'heli_q8/Heli 3D/Pitch rate rad to deg'
 * '<S16>'  : 'heli_q8/Heli 3D/Travel rad to deg'
 * '<S17>'  : 'heli_q8/Heli 3D/Travel rate  rad to deg'
 */
