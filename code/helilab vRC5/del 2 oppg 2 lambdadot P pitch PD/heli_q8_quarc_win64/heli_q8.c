...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  rtb_Frontgain = 0.0;
  rtb_Frontgain += heli_q8_P.TravelTransferFcn_C *
    heli_q8_X.TravelTransferFcn_CSTATE;
  rtb_Frontgain += heli_q8_P.TravelTransferFcn_D * heli_q8_B.TravelCounttorad;

  /* Gain: '<S17>/Gain' */
  heli_q8_B.Gain = heli_q8_P.Gain_Gain * rtb_Frontgain;

  /* Sum: '<Root>/Add' incorporates:
   *  Gain: '<Root>/Gain4'
   *  Gain: '<S4>/Gain1'
   */
  rtb_Add = heli_q8_B.Gain2 - heli_q8_P.Gain4_Gain * heli_q8_B.Gain *
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S12>/Gain' */
    heli_q8_B.Gain_e = heli_q8_P.Gain_Gain_l * heli_q8_B.ElevationCounttorad;

    /* Sum: '<S7>/Sum' incorporates:
     *  Constant: '<Root>/Constant1'
     *  Gain: '<S6>/Gain1'
     */
    rtb_DeadZoney = heli_q8_P.Constant1_Value - heli_q8_P.Gain1_Gain_p *
      heli_q8_B.Gain_e;

    /* Gain: '<S11>/K_ep' */
    heli_q8_B.K_ep = heli_q8_P.K_ep_Gain * rtb_DeadZoney;
  }
  ...
  /* Gain: '<Root>/Gain3' */
  heli_q8_B.Gain3 = heli_q8_P.Krp * rtb_Add;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S2>/Gain1' */
    heli_q8_B.Gain1 = heli_q8_P.Gain1_Gain_o * heli_q8_B.Gain_i;
  }

  /* Sum: '<S10>/  ' */
  heli_q8_B.u = heli_q8_B.Gain3 - heli_q8_B.Gain1;
   ...
   *  Gain: '<S3>/Gain1'
   */
  heli_q8_B.u_j = heli_q8_P.Kpp * heli_q8_B.u - heli_q8_P.Gain1_Gain_i *
    heli_q8_B.Gain_b * heli_q8_P.Kpd;
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_DeadZoney = (rtb_Backgain - heli_q8_B.u_j) * heli_q8_P.Backgain_Gain;

  /* Saturate: '<S8>/Back motor: Saturation' */
  if (rtb_DeadZoney > heli_q8_P.BackmotorSaturation_UpperSat) {
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_UpperSat;
  } else if (rtb_DeadZoney < heli_q8_P.BackmotorSaturation_LowerSat) {
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_LowerSat;
  } else {
    heli_q8_B.BackmotorSaturation = rtb_DeadZoney;
  }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3740560011U);
  heli_q8_M->Sizes.checksums[1] = (512577269U);
  heli_q8_M->Sizes.checksums[2] = (3543619783U);
  heli_q8_M->Sizes.checksums[3] = (4158661150U);
  ...
  heli_q8_M->Sizes.numBlocks = (71);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (27);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (163);/* Sum of parameter "widths" */
  return heli_q8_M;
}
