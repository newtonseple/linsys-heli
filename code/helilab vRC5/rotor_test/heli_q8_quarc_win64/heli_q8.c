...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Add2 = rtb_Gain_i + heli_q8_P.Constant2_Value;
   ...
   *  Gain: '<S13>/Gain'
   */
  rtb_Integrator1 = heli_q8_P.Gain_Gain * heli_q8_B.ElevationTransferFcn *
    heli_q8_P.Gain1_Gain_c;

  /* SignalConversion: '<Root>/ConcatBufferAt   In2' */
  heli_q8_B.u[1] = rtb_Integrator1;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      tmp = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      tmp = 0.0;
    } else {
      tmp = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S9>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * tmp *
    ...
    heli_q8_B.Gain3[0] += heli_q8_P.P[2] * heli_q8_B.Gain1;
    heli_q8_B.Gain3[1] = 0.0;
    heli_q8_B.Gain3[1] += heli_q8_P.P[1] * rtb_Gain2;
    heli_q8_B.Gain3[1] += heli_q8_P.P[3] * heli_q8_B.Gain1;
  }
  ...
  rtb_VectorConcatenate1[2] = rtb_Integrator1;

  /* Integrator: '<Root>/Integrator' */
  rtb_VectorConcatenate1[3] = heli_q8_X.Integrator_CSTATE;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
   ...
   */
  rtb_VectorConcatenate1[4] = heli_q8_B.Gain1_g - heli_q8_X.Integrator1_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    tmp = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp += heli_q8_P.K[(i_0 << 1) + i] * rtb_VectorConcatenate1[i_0];
    }

    heli_q8_B.Sum[i] = heli_q8_B.Gain3[i] - tmp;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S5>/Gain1' */
    rtb_Gain1 = heli_q8_P.Gain1_Gain_b * rtb_Gain_i;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    {
      t_error result;
      heli_q8_DW.HILWriteAnalog_Buffer[0] = heli_q8_P.Constant3_Value;
      heli_q8_DW.HILWriteAnalog_Buffer[1] = heli_q8_P.Constant4_Value;
    ...
    /* Sum: '<Root>/Sum1' */
    heli_q8_B.Sum1 = rtb_Gain1 - rtb_Gain2;
  }
}
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->Integrator1_CSTATE = heli_q8_B.Gain1;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (4099949823U);
  heli_q8_M->Sizes.checksums[1] = (628272207U);
  heli_q8_M->Sizes.checksums[2] = (1466670318U);
  heli_q8_M->Sizes.checksums[3] = (2393125648U);
  ...
  heli_q8_M->Sizes.numBlocks = (78);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (26);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (165);/* Sum of parameter "widths" */
  return heli_q8_M;
}
