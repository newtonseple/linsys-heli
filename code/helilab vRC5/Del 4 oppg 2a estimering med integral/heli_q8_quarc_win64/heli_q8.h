...
struct P_heli_q8_T_ {
  ...
  real_T P[4];                         /* Variable: P
                                        ...
                                        */
  real_T eint_lim_lower;               /* Variable: eint_lim_lower
                                        * Referenced by: '<Root>/Integrator1'
                                        */
  real_T eint_lim_upper;               /* Variable: eint_lim_upper
                                        * Referenced by: '<Root>/Integrator1'
                                        */
  ...
  real_T Gain2_Gain;                   /* Expression: -pi/6
                                        ...
                                        */
  real_T Constant1_Value;              /* Expression: -47
 ...
 * '<S13>'  : 'heli_q8/Elevation controller/Elevation controller'
 * '<S14>'  : 'heli_q8/Heli 3D/Elevation rad to deg'
 * '<S15>'  : 'heli_q8/Heli 3D/Elevation rate rad to deg'
 * '<S16>'  : 'heli_q8/Heli 3D/Pitch rad to deg'
 * '<S17>'  : 'heli_q8/Heli 3D/Pitch rate rad to deg'
 * '<S18>'  : 'heli_q8/Heli 3D/Travel rad to deg'
 * '<S19>'  : 'heli_q8/Heli 3D/Travel rate  rad to deg'
 */
