...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  real_T rtb_Gain_l;
  real_T rtb_Gain1;
  real_T rtb_VectorConcatenate1[5];
  int32_T i;
  real_T tmp[3];
  real_T tmp_0[6];
  real_T tmp_1[6];
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      rtb_Gain_l = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      rtb_Gain_l = 0.0;
    } else {
      rtb_Gain_l = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S11>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * rtb_Gain_l *
  ...
  /* SignalConversion: '<Root>/ConcatBufferAt   In1' */
  heli_q8_B.u[0] = heli_q8_B.Gain1;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S10>/Add2' incorporates:
     *  Constant: '<S10>/Constant2'
     */
    heli_q8_B.Add2 = rtb_HILReadEncoderTimebase_o3 + heli_q8_P.Constant2_Value;

    /* Gain: '<S10>/Elevation: Count to rad' */
    heli_q8_B.ElevationCounttorad = heli_q8_P.ElevationCounttorad_Gain *
      heli_q8_B.Add2;
  }

  /* TransferFcn: '<S10>/Elevation: Transfer Fcn' */
   ...
   *  Gain: '<S15>/Gain'
   */
  rtb_Gain1 = heli_q8_P.Gain_Gain * heli_q8_B.ElevationTransferFcn *
    heli_q8_P.Gain1_Gain_c;

  /* SignalConversion: '<Root>/ConcatBufferAt   In2' */
  heli_q8_B.u[1] = rtb_Gain1;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
   ...
   *  Limited Integrator
   */
  if (heli_q8_X.Integrator1_CSTATE >= heli_q8_P.eint_lim_upper ) {
    heli_q8_X.Integrator1_CSTATE = heli_q8_P.eint_lim_upper;
  } else if (heli_q8_X.Integrator1_CSTATE <= heli_q8_P.eint_lim_lower ) {
    heli_q8_X.Integrator1_CSTATE = heli_q8_P.eint_lim_lower;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      tmp_2 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      tmp_2 = 0.0;
    } else {
      tmp_2 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S11>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * tmp_2 *
      heli_q8_P.Joystick_gain_x;

    /* Gain: '<Root>/Gain2' */
    heli_q8_B.Gain2 = heli_q8_P.Gain2_Gain * heli_q8_B.Joystick_gain_x;

    /* SignalConversion: '<Root>/ConcatBufferAt    In1' */
    heli_q8_B.u_d[0] = heli_q8_B.Gain2;

    /* Sum: '<S10>/Add1' incorporates:
     *  Constant: '<S10>/Constant1'
     */
    heli_q8_B.Add1 = rtb_HILReadEncoderTimebase_o2 + heli_q8_P.Constant1_Value;

    /* Gain: '<S10>/Pitch: Count to rad' */
    heli_q8_B.PitchCounttorad = heli_q8_P.PitchCounttorad_Gain * heli_q8_B.Add1;

    /* Gain: '<S16>/Gain' */
    rtb_Gain_l = heli_q8_P.Gain_Gain_a * heli_q8_B.PitchCounttorad;

    /* Gain: '<S2>/Gain1' */
    heli_q8_B.u_d[1] = heli_q8_P.Gain1_Gain_o * rtb_Gain_l;

    /* SignalConversion: '<Root>/ConcatBufferAtVector ConcatenateIn1' */
    heli_q8_B.VectorConcatenate[0] = heli_q8_B.Gain2;

    /* SignalConversion: '<Root>/ConcatBufferAtVector ConcatenateIn2' */
    heli_q8_B.VectorConcatenate[1] = heli_q8_B.Gain1;

    /* Gain: '<Root>/Gain3' */
    heli_q8_B.Gain3[0] = 0.0;
    heli_q8_B.Gain3[0] += heli_q8_P.P[0] * heli_q8_B.VectorConcatenate[0];
    heli_q8_B.Gain3[0] += heli_q8_P.P[2] * heli_q8_B.VectorConcatenate[1];
    heli_q8_B.Gain3[1] = 0.0;
    heli_q8_B.Gain3[1] += heli_q8_P.P[1] * heli_q8_B.VectorConcatenate[0];
    heli_q8_B.Gain3[1] += heli_q8_P.P[3] * heli_q8_B.VectorConcatenate[1];
  }

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate1In1' incorporates:
   *  Integrator: '<Root>/Integrator2'
   */
  rtb_VectorConcatenate1[0] = heli_q8_X.Integrator2_CSTATE[0];
  rtb_VectorConcatenate1[1] = heli_q8_X.Integrator2_CSTATE[1];
  rtb_VectorConcatenate1[2] = heli_q8_X.Integrator2_CSTATE[3];

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate1In2' */
  rtb_VectorConcatenate1[3] = heli_q8_B.Integrator;

  /* Sum: '<Root>/Sum2' incorporates:
   *  Integrator: '<Root>/Integrator2'
   */
  rtb_VectorConcatenate1[4] = heli_q8_X.Integrator2_CSTATE[2] -
  ...
  for (i = 0; i < 2; i++) {
    tmp_2 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_2 += heli_q8_P.K[(i_0 << 1) + i] * rtb_VectorConcatenate1[i_0];
    }

    heli_q8_B.Sum[i] = heli_q8_B.Gain3[i] - tmp_2;
  }

  /* End of Sum: '<Root>/Sum' */

  /* Bias: '<Root>/Bias' */
  heli_q8_B.Bias = -heli_q8_P.L_2 / heli_q8_P.L_3 + heli_q8_B.Sum[0];

  /* Gain: '<S1>/Back gain' incorporates:
   *  Sum: '<S1>/Subtract'
   */
  heli_q8_B.Backgain = (heli_q8_B.Bias - heli_q8_B.Sum[1]) *
   ...
   *  Sum: '<S1>/Add'
   */
  heli_q8_B.Frontgain = (heli_q8_B.Sum[1] + heli_q8_B.Bias) *
    heli_q8_P.Frontgain_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S6>/Gain1' incorporates:
     *  Gain: '<S14>/Gain'
     */
    heli_q8_B.Gain1_g = heli_q8_P.Gain_Gain_l * heli_q8_B.ElevationCounttorad *
      heli_q8_P.Gain1_Gain_p;
  }

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate4In1' */
  heli_q8_B.VectorConcatenate4[0] = heli_q8_B.Gain1_g;

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate4In2' incorporates:
   *  Integrator: '<Root>/Integrator2'
   */
  heli_q8_B.VectorConcatenate4[1] = heli_q8_X.Integrator2_CSTATE[2];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate5In1' */
  heli_q8_B.VectorConcatenate5[0] = rtb_Gain1;

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate5In2' incorporates:
   *  Integrator: '<Root>/Integrator2'
   */
  heli_q8_B.VectorConcatenate5[1] = heli_q8_X.Integrator2_CSTATE[3];

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate5In3' */
  heli_q8_B.VectorConcatenate5[2] = heli_q8_B.VectorConcatenate[1];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S10>/Add' incorporates:
     *  Constant: '<S10>/Constant'
     */
    heli_q8_B.Add = rtb_HILReadEncoderTimebase_o1 + heli_q8_P.Constant_Value;

    /* Gain: '<S10>/Travel: Count to rad' */
    heli_q8_B.TravelCounttorad = heli_q8_P.TravelCounttorad_Gain * heli_q8_B.Add;

    /* Gain: '<S7>/Gain1' incorporates:
     *  Gain: '<S18>/Gain'
     */
    heli_q8_B.Gain1_j = heli_q8_P.Gain_Gain_ar * heli_q8_B.TravelCounttorad *
      heli_q8_P.Gain1_Gain_j;
  }

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate6In1' */
  heli_q8_B.VectorConcatenate6[0] = heli_q8_B.Gain1_j;

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate6In2' incorporates:
   *  Integrator: '<Root>/Integrator2'
   */
  heli_q8_B.VectorConcatenate6[1] = heli_q8_X.Integrator2_CSTATE[4];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }

  /* TransferFcn: '<S10>/Travel: Transfer Fcn' */
   ...
   *  Gain: '<S19>/Gain'
   */
  heli_q8_B.VectorConcatenate7[0] = heli_q8_P.Gain_Gain_lu *
    heli_q8_B.TravelTransferFcn * heli_q8_P.Gain1_Gain_b;

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate7In2' incorporates:
   *  Integrator: '<Root>/Integrator2'
   */
  heli_q8_B.VectorConcatenate7[1] = heli_q8_X.Integrator2_CSTATE[5];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S5>/Gain1' */
    heli_q8_B.Gain1_a = heli_q8_P.Gain1_Gain_bl * rtb_Gain_l;
  }

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate3In1' */
  heli_q8_B.VectorConcatenate3[0] = heli_q8_B.Gain1_a;

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate3In2' incorporates:
   *  Integrator: '<Root>/Integrator2'
   */
  heli_q8_B.VectorConcatenate3[1] = heli_q8_X.Integrator2_CSTATE[0];

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate3In3' */
  heli_q8_B.VectorConcatenate3[2] = heli_q8_B.VectorConcatenate[0];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }

  /* TransferFcn: '<S10>/Pitch: Transfer Fcn' */
   ...
   *  Gain: '<S17>/Gain'
   */
  heli_q8_B.VectorConcatenate2[0] = heli_q8_P.Gain_Gain_ae *
    heli_q8_B.PitchTransferFcn * heli_q8_P.Gain1_Gain_i;

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate2In2' incorporates:
   *  Integrator: '<Root>/Integrator2'
   */
  heli_q8_B.VectorConcatenate2[1] = heli_q8_X.Integrator2_CSTATE[1];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* SignalConversion: '<Root>/ConcatBufferAty_measIn1' */
    heli_q8_B.y_meas[0] = heli_q8_B.Gain1_a;

    /* SignalConversion: '<Root>/ConcatBufferAty_measIn2' */
    heli_q8_B.y_meas[1] = heli_q8_B.Gain1_g;

    /* SignalConversion: '<Root>/ConcatBufferAty_measIn3' */
    heli_q8_B.y_meas[2] = heli_q8_B.Gain1_j;
  }

  /* Saturate: '<S10>/Front motor: Saturation' */
  ...
  /* End of Saturate: '<S10>/Front motor: Saturation' */

  /* Saturate: '<S10>/Back motor: Saturation' */
  ...
  /* End of Saturate: '<S10>/Back motor: Saturation' */
  if (rtmIsMajorTimeStep(heli_q8_M)) {
   ...
   *  Integrator: '<Root>/Integrator2'
   */
  heli_q8_B.Sum1 = heli_q8_X.Integrator2_CSTATE[0] - heli_q8_B.Gain2;
  ...
  for (i = 0; i < 3; i++) {
    tmp_2 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_2 += heli_q8_P.C_obsv[3 * i_0 + i] * heli_q8_X.Integrator2_CSTATE[i_0];
    }

    tmp[i] = heli_q8_B.y_meas[i] - tmp_2;
  }
  ...
  for (i = 0; i < 6; i++) {
     ...
     *  Sum: '<Root>/Sum3'
     */
    tmp_0[i] = heli_q8_P.L[i + 12] * tmp[2] + (heli_q8_P.L[i + 6] * tmp[1] +
      heli_q8_P.L[i] * tmp[0]);

    /* Gain: '<Root>/Gain5' incorporates:
     *  Sum: '<Root>/Sum3'
     */
    tmp_1[i] = heli_q8_P.B_obsv[i + 6] * heli_q8_B.Sum[1] + heli_q8_P.B_obsv[i] *
      heli_q8_B.Sum[0];
  }
  ...
  for (i = 0; i < 6; i++) {
    tmp_2 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_2 += heli_q8_P.A_obsv[6 * i_0 + i] * heli_q8_X.Integrator2_CSTATE[i_0];
    }

    heli_q8_B.Sum3[i] = (tmp_0[i] + tmp_1[i]) + tmp_2;
  }
}
...
void heli_q8_derivatives(void)
{
  ...
  /* Derivatives for TransferFcn: '<S10>/Elevation: Transfer Fcn' */
  ...
  /* Derivatives for Integrator: '<Root>/Integrator1' */
  {
    boolean_T lsat;
    boolean_T usat;
    lsat = ( heli_q8_X.Integrator1_CSTATE <= heli_q8_P.eint_lim_lower );
    usat = ( heli_q8_X.Integrator1_CSTATE >= heli_q8_P.eint_lim_upper );
    if ((!lsat && !usat) ||
        (lsat && (heli_q8_B.Gain1 > 0)) ||
        (usat && (heli_q8_B.Gain1 < 0)) ) {
      ((XDot_heli_q8_T *) heli_q8_M->ModelData.derivs)->Integrator1_CSTATE =
        heli_q8_B.Gain1;
    } else {
      /* in saturation */
      ((XDot_heli_q8_T *) heli_q8_M->ModelData.derivs)->Integrator1_CSTATE = 0.0;
    }
  }
  ...
  for (i = 0; i < 6; i++) {
    _rtXdot->Integrator2_CSTATE[i] = heli_q8_B.Sum3[i];
  }

  /* End of Derivatives for Integrator: '<Root>/Integrator2' */

  /* Derivatives for TransferFcn: '<S10>/Travel: Transfer Fcn' */
  ...
  /* Derivatives for TransferFcn: '<S10>/Pitch: Transfer Fcn' */
...
void heli_q8_initialize(void)
{
...

  {
    ...
    /* InitializeConditions for TransferFcn: '<S10>/Elevation: Transfer Fcn' */
    ...
    /* InitializeConditions for TransferFcn: '<S10>/Travel: Transfer Fcn' */
    heli_q8_X.TravelTransferFcn_CSTATE = 0.0;

    /* InitializeConditions for TransferFcn: '<S10>/Pitch: Transfer Fcn' */
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3405283057U);
  heli_q8_M->Sizes.checksums[1] = (438629013U);
  heli_q8_M->Sizes.checksums[2] = (3098877U);
  heli_q8_M->Sizes.checksums[3] = (3531187680U);
...

  {
    ...
    heli_q8_B.u_d[0] = 0.0;
    heli_q8_B.u_d[1] = 0.0;
    heli_q8_B.VectorConcatenate[0] = 0.0;
    heli_q8_B.VectorConcatenate[1] = 0.0;
    heli_q8_B.Gain3[0] = 0.0;
    heli_q8_B.Gain3[1] = 0.0;
    heli_q8_B.Sum[0] = 0.0;
    heli_q8_B.Sum[1] = 0.0;
    ...
    heli_q8_B.Gain1_g = 0.0;
    heli_q8_B.VectorConcatenate4[0] = 0.0;
    heli_q8_B.VectorConcatenate4[1] = 0.0;
    heli_q8_B.VectorConcatenate5[0] = 0.0;
    heli_q8_B.VectorConcatenate5[1] = 0.0;
    heli_q8_B.VectorConcatenate5[2] = 0.0;
    heli_q8_B.Add = 0.0;
    heli_q8_B.TravelCounttorad = 0.0;
    heli_q8_B.Gain1_j = 0.0;
    heli_q8_B.VectorConcatenate6[0] = 0.0;
    heli_q8_B.VectorConcatenate6[1] = 0.0;
    heli_q8_B.TravelTransferFcn = 0.0;
    heli_q8_B.VectorConcatenate7[0] = 0.0;
    heli_q8_B.VectorConcatenate7[1] = 0.0;
    heli_q8_B.Gain1_a = 0.0;
    heli_q8_B.VectorConcatenate3[0] = 0.0;
    heli_q8_B.VectorConcatenate3[1] = 0.0;
    heli_q8_B.VectorConcatenate3[2] = 0.0;
    heli_q8_B.PitchTransferFcn = 0.0;
    heli_q8_B.VectorConcatenate2[0] = 0.0;
    heli_q8_B.VectorConcatenate2[1] = 0.0;
    heli_q8_B.y_meas[0] = 0.0;
    heli_q8_B.y_meas[1] = 0.0;
    heli_q8_B.y_meas[2] = 0.0;
  ...
  /* Initialize Sizes */
  heli_q8_M->Sizes.numContStates = (11);/* Number of continuous states */
  ...
  heli_q8_M->Sizes.numBlocks = (118);  /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (41);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (258);/* Sum of parameter "widths" */
  return heli_q8_M;
}
