...
MODEL                = heli_q8_uint
MODULES              = heli_q8_uint_data.c heli_q8_uint_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_uint.mk
...
MODELLIB                  = heli_q8_uintlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_uint_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\didrikr\Desktop\HELILA~2\DEL4OP~2
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_uint_quarc_win64
