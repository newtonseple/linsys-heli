...
typedef struct {
  ...
  real_T RateTransitiony;              /* '<S11>/Rate Transition: y' */
  real_T Joystick_gain_y;              /* '<S11>/Joystick_gain_y' */
  real_T Gain1;                        /* '<Root>/Gain1' */
  real_T Constant1;                    /* '<Root>/Constant1' */
  real_T Constant3;                    /* '<Root>/Constant3' */
  real_T Switch2;                      /* '<S13>/Switch2' */
  real_T Add2;                         /* '<S10>/Add2' */
  real_T ElevationCounttorad;          /* '<S10>/Elevation: Count to rad' */
  real_T ElevationTransferFcn;         /* '<S10>/Elevation: Transfer Fcn' */
  real_T u[2];                         /* '<Root>/   ' */
  real_T Sum2;                         /* '<Root>/Sum2' */
  real_T Integrator;                   /* '<Root>/Integrator' */
  real_T RateTransitionx;              /* '<S11>/Rate Transition: x' */
  real_T Joystick_gain_x;              /* '<S11>/Joystick_gain_x' */
  real_T Gain2;                        /* '<Root>/Gain2' */
  real_T Add1;                         /* '<S10>/Add1' */
  real_T PitchCounttorad;              /* '<S10>/Pitch: Count to rad' */
  real_T u_d[2];                       /* '<Root>/    ' */
  real_T Sum[2];                       /* '<Root>/Sum' */
  real_T Bias;                         /* '<Root>/Bias' */
  real_T Backgain;                     /* '<S1>/Back gain' */
  real_T Frontgain;                    /* '<S1>/Front gain' */
  real_T Gain1_g;                      /* '<S6>/Gain1' */
  real_T VectorConcatenate4[2];        /* '<Root>/Vector Concatenate4' */
  real_T VectorConcatenate5[3];        /* '<Root>/Vector Concatenate5' */
  real_T Add;                          /* '<S10>/Add' */
  real_T TravelCounttorad;             /* '<S10>/Travel: Count to rad' */
  real_T Gain1_j;                      /* '<S7>/Gain1' */
  real_T VectorConcatenate6[2];        /* '<Root>/Vector Concatenate6' */
  real_T TravelTransferFcn;            /* '<S10>/Travel: Transfer Fcn' */
  ...
  real_T PitchTransferFcn;             /* '<S10>/Pitch: Transfer Fcn' */
  real_T VectorConcatenate2[2];        /* '<Root>/Vector Concatenate2' */
  real_T y_meas[3];                    /* '<Root>/y_meas' */
  real_T FrontmotorSaturation;         /* '<S10>/Front motor: Saturation' */
  real_T BackmotorSaturation;          /* '<S10>/Back motor: Saturation' */
  real_T GameController_o4;            /* '<S11>/Game Controller' */
  real_T GameController_o5;            /* '<S11>/Game Controller' */
...
typedef struct {
  ...
  real_T RateTransitiony_Buffer0;      /* '<S11>/Rate Transition: y' */
  real_T RateTransitionx_Buffer0;      /* '<S11>/Rate Transition: x' */
  real_T HILWriteAnalog_Buffer[2];     /* '<S10>/HIL Write Analog' */
  t_game_controller GameController_Controller;/* '<S11>/Game Controller' */
  t_card HILInitialize_Card;           /* '<Root>/HIL Initialize' */
  t_task HILReadEncoderTimebase_Task;  /* '<S10>/HIL Read Encoder Timebase' */
  struct {
    void *LoggedData;
  } ElevRefScoperads_PWORK;            /* '<Root>/Elev. Ref. Scope <rad//s>' */

  struct {
    void *LoggedData;
  } Elevint_PWORK;                     /* '<Root>/Elev. int' */

  struct {
    void *LoggedData;
  } Pitchint_PWORK;                    /* '<Root>/Pitch int' */

  struct {
    void *LoggedData;
  } Pitchrefscoperad_PWORK;            /* '<Root>/Pitch ref. scope <rad>' */
  ...
  struct {
    void *LoggedData;
  } ElevationScopedegs_PWORK;          /* '<S10>/Elevation: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } ElevationScopedeg_PWORK;           /* '<S10>/Elevation: Scope [deg]' */

  struct {
    void *LoggedData;
  } PitchScopedeg_PWORK;               /* '<S10>/Pitch: Scope [deg]' */

  struct {
    void *LoggedData;
  } PtichrateScopedegs_PWORK;          /* '<S10>/Ptich rate: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } TravelrateScopedegs_PWORK;         /* '<S10>/Travel rate: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } TravelScopedeg_PWORK;              /* '<S10>/Travel: Scope [deg]' */

  void *HILWriteAnalog_PWORK;          /* '<S10>/HIL Write Analog' */
  struct {
    void *LoggedData;
  } XScope_PWORK;                      /* '<S11>/X: Scope' */

  struct {
    void *LoggedData;
  } YScope_PWORK;                      /* '<S11>/Y: Scope' */
  ...
  int32_T HILReadEncoderTimebase_Buffer[3];/* '<S10>/HIL Read Encoder Timebase' */
...
typedef struct {
  ...
  real_T ElevationTransferFcn_CSTATE;  /* '<S10>/Elevation: Transfer Fcn' */
  real_T Integrator1_CSTATE;           /* '<Root>/Integrator1' */
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
  real_T TravelTransferFcn_CSTATE;     /* '<S10>/Travel: Transfer Fcn' */
  real_T PitchTransferFcn_CSTATE;      /* '<S10>/Pitch: Transfer Fcn' */
} X_heli_q8_T;
...
typedef struct {
  ...
  boolean_T ElevationTransferFcn_CSTATE;/* '<S10>/Elevation: Transfer Fcn' */
  boolean_T Integrator1_CSTATE;        /* '<Root>/Integrator1' */
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
  boolean_T TravelTransferFcn_CSTATE;  /* '<S10>/Travel: Transfer Fcn' */
  boolean_T PitchTransferFcn_CSTATE;   /* '<S10>/Pitch: Transfer Fcn' */
} XDis_heli_q8_T;
...
struct P_heli_q8_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T Switch1_Threshold;            /* Expression: -0.4
  ...
  real_T Integrator2_IC;               /* Expression: 0
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: 999
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T Switch_Threshold;             /* Expression: 0.4
  ...
  real_T Gainy_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Gain1_Gain;                   /* Expression: -pi/12
                                        * Referenced by: '<Root>/Gain1'
                                        */
  real_T Constant1_Value;              /* Expression: -999
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T Constant3_Value;              /* Expression: 0
                                        * Referenced by: '<Root>/Constant3'
                                        */
  real_T Constant2_Value_e;            /* Expression: 311
  ...
  real_T Gainx_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Gain2_Gain;                   /* Expression: -pi/6
                                        * Referenced by: '<Root>/Gain2'
                                        */
  real_T Constant1_Value_p;            /* Expression: -47
  ...
  real_T Gain1_Gain_p;                 /* Expression: pi/180
                                        ...
                                        */
  real_T Constant_Value_d;             /* Expression: -69
  ...
  real_T Gain1_Gain_b;                 /* Expression: pi/180
                                        ...
                                        */
  real_T Gain1_Gain_bl;                /* Expression: pi/180
 ...
 * '<S2>'   : 'heli_q8/Degrees to Radians'
 * '<S3>'   : 'heli_q8/Degrees to Radians1'
 * '<S4>'   : 'heli_q8/Degrees to Radians2'
 * '<S5>'   : 'heli_q8/Degrees to Radians3'
 * '<S6>'   : 'heli_q8/Degrees to Radians4'
 * '<S7>'   : 'heli_q8/Degrees to Radians5'
 * '<S8>'   : 'heli_q8/Degrees to Radians6'
 * '<S9>'   : 'heli_q8/Elevation controller'
 * '<S10>'  : 'heli_q8/Heli 3D'
 * '<S11>'  : 'heli_q8/Joystick'
 * '<S12>'  : 'heli_q8/Pitch controller'
 * '<S13>'  : 'heli_q8/Saturation Dynamic'
 * '<S14>'  : 'heli_q8/Elevation controller/Elevation controller'
 * '<S15>'  : 'heli_q8/Heli 3D/Elevation rad to deg'
 * '<S16>'  : 'heli_q8/Heli 3D/Elevation rate rad to deg'
 * '<S17>'  : 'heli_q8/Heli 3D/Pitch rad to deg'
 * '<S18>'  : 'heli_q8/Heli 3D/Pitch rate rad to deg'
 * '<S19>'  : 'heli_q8/Heli 3D/Travel rad to deg'
 * '<S20>'  : 'heli_q8/Heli 3D/Travel rate  rad to deg'
 */
