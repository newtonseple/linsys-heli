  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(42).logicalSrcIdx = 119;
	  section.data(42).dtTransOffset = 41;
	
	  ;% heli_q8_P.Gain1_Gain_b
	  section.data(43).logicalSrcIdx = 120;
	  section.data(43).dtTransOffset = 42;
	
	  ;% heli_q8_P.Gain1_Gain_bl
	  section.data(44).logicalSrcIdx = 121;
	  section.data(44).dtTransOffset = 43;
	
	  ;% heli_q8_P.PitchTransferFcn_A
	  section.data(45).logicalSrcIdx = 122;
	  section.data(45).dtTransOffset = 44;
	
	  ;% heli_q8_P.PitchTransferFcn_C
	  section.data(46).logicalSrcIdx = 123;
	  section.data(46).dtTransOffset = 45;
	
	  ;% heli_q8_P.PitchTransferFcn_D
	  section.data(47).logicalSrcIdx = 124;
	  section.data(47).dtTransOffset = 46;
	
	  ;% heli_q8_P.Gain_Gain_ae
	  section.data(48).logicalSrcIdx = 125;
	  section.data(48).dtTransOffset = 47;
	
	  ;% heli_q8_P.Gain1_Gain_i
	  section.data(49).logicalSrcIdx = 126;
	  section.data(49).dtTransOffset = 48;
	
	  ;% heli_q8_P.FrontmotorSaturation_UpperSat
	  section.data(50).logicalSrcIdx = 127;
	  section.data(50).dtTransOffset = 49;
	
	  ;% heli_q8_P.FrontmotorSaturation_LowerSat
	  section.data(51).logicalSrcIdx = 128;
	  section.data(51).dtTransOffset = 50;
	
	  ;% heli_q8_P.BackmotorSaturation_UpperSat
	  section.data(52).logicalSrcIdx = 129;
	  section.data(52).dtTransOffset = 51;
	
	  ;% heli_q8_P.BackmotorSaturation_LowerSat
	  section.data(53).logicalSrcIdx = 130;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% heli_q8_B.VectorConcatenate4
	  section.data(26).logicalSrcIdx = 25;
	  section.data(26).dtTransOffset = 28;
	
	  ;% heli_q8_B.VectorConcatenate5
	  section.data(27).logicalSrcIdx = 26;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.ElevRefScoperads_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_DW.Elevint_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_DW.Pitchint_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_DW.Pitchrefscoperad_PWORK.LoggedData
	  ...
	  ;% heli_q8_DW.Vd_PWORK.LoggedData
	  ...
	  ;% heli_q8_DW.e_est_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 22;
	  section.data(9).dtTransOffset = 8;
	
	  ;% heli_q8_DW.ed_est_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 23;
	  section.data(10).dtTransOffset = 9;
	
	  ;% heli_q8_DW.l_est_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 24;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_q8_DW.ld_est_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 25;
	  section.data(12).dtTransOffset = 11;
	
	  ;% heli_q8_DW.p_est_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 26;
	  section.data(13).dtTransOffset = 12;
	
	  ;% heli_q8_DW.pd_est_PWORK.LoggedData
  ...
  targMap.checksum0 = 2686201281;
  targMap.checksum1 = 37247755;
  targMap.checksum2 = 4189137458;
  targMap.checksum3 = 3586342053;
