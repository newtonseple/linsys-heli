 ...
 * C source code generated on : Thu Oct 20 12:16:43 2016
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  if (heli_q8_X.Integrator2_CSTATE[2] >= heli_q8_P.Switch_Threshold) {
    rtb_Gain1 = heli_q8_B.Constant2;
  } else {
    rtb_Gain1 = heli_q8_B.Constant;
  }

  /* End of Switch: '<Root>/Switch' */

  /* RateTransition: '<S11>/Rate Transition: y' incorporates:
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.Constant1 = heli_q8_P.Constant1_Value;
    heli_q8_B.Constant3 = heli_q8_P.Constant3_Value;
  }
   ...
   *  Switch: '<Root>/Switch1'
   */
  if (heli_q8_B.Gain1 > rtb_Gain1) {
    heli_q8_B.Switch2 = rtb_Gain1;
  } else {
    if (heli_q8_X.Integrator2_CSTATE[2] >= heli_q8_P.Switch1_Threshold) {
      /* Switch: '<Root>/Switch1' */
      rtb_Gain1 = heli_q8_B.Constant1;
    } else {
      /* Switch: '<Root>/Switch1' */
      rtb_Gain1 = heli_q8_B.Constant3;
    }
    ...
    if (heli_q8_B.Gain1 < rtb_Gain1) {
      ...
      heli_q8_B.Switch2 = heli_q8_B.Gain1;
    }
  ...
  heli_q8_B.u[0] = heli_q8_B.Switch2;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S10>/Add2' incorporates:
     *  Constant: '<S10>/Constant2'
     */
    heli_q8_B.Add2 = rtb_HILReadEncoderTimebase_o3 + heli_q8_P.Constant2_Value_e;
   ...
   *  Integrator: '<Root>/Integrator2'
   */
  heli_q8_B.Sum2 = heli_q8_X.Integrator2_CSTATE[2] -
    heli_q8_X.Integrator1_CSTATE;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      rtb_Gain_l = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      rtb_Gain_l = 0.0;
    } else {
      rtb_Gain_l = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S11>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * rtb_Gain_l *
     ...
     */
    heli_q8_B.Add1 = rtb_HILReadEncoderTimebase_o2 + heli_q8_P.Constant1_Value_p;
  ...
  rtb_VectorConcatenate1[4] = heli_q8_B.Sum2;
  ...
  for (i = 0; i < 2; i++) {
    tmp[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp[i] += heli_q8_P.K[(i_0 << 1) + i] * rtb_VectorConcatenate1[i_0];
    }
  }
   ...
   */
  heli_q8_B.Sum[0] = (heli_q8_P.P[0] * heli_q8_B.Gain2 + heli_q8_P.P[2] *
                      heli_q8_B.Switch2) - tmp[0];
  heli_q8_B.Sum[1] = (heli_q8_P.P[1] * heli_q8_B.Gain2 + heli_q8_P.P[3] *
                      heli_q8_B.Switch2) - tmp[1];
  ...
  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate5In3' incorporates:
   *  SignalConversion: '<Root>/ConcatBufferAtVector ConcatenateIn2'
   */
  heli_q8_B.VectorConcatenate5[2] = heli_q8_B.Switch2;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S10>/Add' incorporates:
     *  Constant: '<S10>/Constant'
     */
    heli_q8_B.Add = rtb_HILReadEncoderTimebase_o1 + heli_q8_P.Constant_Value_d;
  ...
  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate3In3' incorporates:
   *  SignalConversion: '<Root>/ConcatBufferAtVector ConcatenateIn1'
   */
  heli_q8_B.VectorConcatenate3[2] = heli_q8_B.Gain2;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
  ...
  for (i = 0; i < 3; i++) {
    rtb_Gain_l = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_Gain_l += heli_q8_P.C_obsv[3 * i_0 + i] *
        heli_q8_X.Integrator2_CSTATE[i_0];
    }

    tmp_0[i] = heli_q8_B.y_meas[i] - rtb_Gain_l;
  }
  ...
  for (i = 0; i < 6; i++) {
     ...
     *  Sum: '<Root>/Sum3'
     */
    tmp_1[i] = heli_q8_P.L[i + 12] * tmp_0[2] + (heli_q8_P.L[i + 6] * tmp_0[1] +
      heli_q8_P.L[i] * tmp_0[0]);

    /* Gain: '<Root>/Gain5' incorporates:
     *  Sum: '<Root>/Sum3'
     */
    tmp_2[i] = heli_q8_P.B_obsv[i + 6] * heli_q8_B.Sum[1] + heli_q8_P.B_obsv[i] *
      heli_q8_B.Sum[0];
  }
  ...
  for (i = 0; i < 6; i++) {
    rtb_Gain_l = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_Gain_l += heli_q8_P.A_obsv[6 * i_0 + i] *
        heli_q8_X.Integrator2_CSTATE[i_0];
    }

    heli_q8_B.Sum3[i] = (tmp_1[i] + tmp_2[i]) + rtb_Gain_l;
  }
}
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->Integrator1_CSTATE = heli_q8_B.Switch2;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2686201281U);
  heli_q8_M->Sizes.checksums[1] = (37247755U);
  heli_q8_M->Sizes.checksums[2] = (4189137458U);
  heli_q8_M->Sizes.checksums[3] = (3586342053U);
  ...
  heli_q8_M->Sizes.numBlocks = (130);  /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (44);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (262);/* Sum of parameter "widths" */
  return heli_q8_M;
}
