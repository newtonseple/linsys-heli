 ...
 */
#ifndef RTW_HEADER_heli_q8_uint_h_
#define RTW_HEADER_heli_q8_uint_h_
#include <string.h>
#ifndef heli_q8_uint_COMMON_INCLUDES_
# define heli_q8_uint_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_uint_COMMON_INCLUDES_ */

#include "heli_q8_uint_types.h"
...
#define heli_q8_uint_rtModel           RT_MODEL_heli_q8_uint_T
...
typedef struct {
  ...
  real_T Add2;                         /* '<S9>/Add2' */
  real_T ElevationCounttorad;          /* '<S9>/Elevation: Count to rad' */
  real_T Gain1;                        /* '<S5>/Gain1' */
  real_T VectorConcatenate4[2];        /* '<Root>/Vector Concatenate4' */
  real_T ElevationTransferFcn;         /* '<S9>/Elevation: Transfer Fcn' */
  real_T VectorConcatenate5[3];        /* '<Root>/Vector Concatenate5' */
  real_T Add;                          /* '<S9>/Add' */
  real_T TravelCounttorad;             /* '<S9>/Travel: Count to rad' */
  real_T Gain1_e;                      /* '<S6>/Gain1' */
  real_T VectorConcatenate6[2];        /* '<Root>/Vector Concatenate6' */
  real_T TravelTransferFcn;            /* '<S9>/Travel: Transfer Fcn' */
  real_T VectorConcatenate7[2];        /* '<Root>/Vector Concatenate7' */
  real_T Add1;                         /* '<S9>/Add1' */
  real_T PitchCounttorad;              /* '<S9>/Pitch: Count to rad' */
  real_T VectorConcatenate3[3];        /* '<Root>/Vector Concatenate3' */
  real_T PitchTransferFcn;             /* '<S9>/Pitch: Transfer Fcn' */
  real_T VectorConcatenate2[2];        /* '<Root>/Vector Concatenate2' */
  real_T y_meas[2];                    /* '<Root>/y_meas' */
  real_T FrontmotorSaturation;         /* '<S9>/Front motor: Saturation' */
  real_T BackmotorSaturation;          /* '<S9>/Back motor: Saturation' */
  real_T GameController_o4;            /* '<S10>/Game Controller' */
  real_T GameController_o5;            /* '<S10>/Game Controller' */
  real_T Sum3[6];                      /* '<Root>/Sum3' */
} B_heli_q8_uint_T;
...
typedef struct {
  ...
  real_T HILWriteAnalog_Buffer[2];     /* '<S9>/HIL Write Analog' */
  t_game_controller GameController_Controller;/* '<S10>/Game Controller' */
  t_card HILInitialize_Card;           /* '<Root>/HIL Initialize' */
  t_task HILReadEncoderTimebase_Task;  /* '<S9>/HIL Read Encoder Timebase' */
  struct {
    void *LoggedData;
  } Vb_PWORK;                          /* '<Root>/Vb ' */
  ...
  struct {
    void *LoggedData;
  } e_est_PWORK;                       /* '<Root>/e_est' */

  struct {
    void *LoggedData;
  } ed_est_PWORK;                      /* '<Root>/ed_est' */

  struct {
    void *LoggedData;
  } l_est_PWORK;                       /* '<Root>/l_est' */

  struct {
    void *LoggedData;
  } ld_est_PWORK;                      /* '<Root>/ld_est' */

  struct {
    void *LoggedData;
  } p_est_PWORK;                       /* '<Root>/p_est' */

  struct {
    void *LoggedData;
  } pd_est_PWORK;                      /* '<Root>/pd_est' */

  struct {
    void *LoggedData;
  } ElevationScopedegs_PWORK;          /* '<S9>/Elevation: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } ElevationScopedeg_PWORK;           /* '<S9>/Elevation: Scope [deg]' */

  struct {
    void *LoggedData;
  } PitchScopedeg_PWORK;               /* '<S9>/Pitch: Scope [deg]' */

  struct {
    void *LoggedData;
  } PtichrateScopedegs_PWORK;          /* '<S9>/Ptich rate: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } TravelrateScopedegs_PWORK;         /* '<S9>/Travel rate: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } TravelScopedeg_PWORK;              /* '<S9>/Travel: Scope [deg]' */

  void *HILWriteAnalog_PWORK;          /* '<S9>/HIL Write Analog' */
  struct {
    void *LoggedData;
  ...
  int32_T HILReadEncoderTimebase_Buffer[3];/* '<S9>/HIL Read Encoder Timebase' */
...
typedef struct {
  ...
  real_T ElevationTransferFcn_CSTATE;  /* '<S9>/Elevation: Transfer Fcn' */
  real_T TravelTransferFcn_CSTATE;     /* '<S9>/Travel: Transfer Fcn' */
  real_T PitchTransferFcn_CSTATE;      /* '<S9>/Pitch: Transfer Fcn' */
} X_heli_q8_uint_T;
...
typedef struct {
  ...
  boolean_T ElevationTransferFcn_CSTATE;/* '<S9>/Elevation: Transfer Fcn' */
  boolean_T TravelTransferFcn_CSTATE;  /* '<S9>/Travel: Transfer Fcn' */
  boolean_T PitchTransferFcn_CSTATE;   /* '<S9>/Pitch: Transfer Fcn' */
} XDis_heli_q8_uint_T;
...
#define rtB                            heli_q8_uint_B
#define BlockIO                        B_heli_q8_uint_T
#define rtX                            heli_q8_uint_X
#define ContinuousStates               X_heli_q8_uint_T
#define rtXdot                         heli_q8_uint_XDot
#define StateDerivatives               XDot_heli_q8_uint_T
#define tXdis                          heli_q8_uint_XDis
#define StateDisabled                  XDis_heli_q8_uint_T
#define rtP                            heli_q8_uint_P
#define Parameters                     P_heli_q8_uint_T
#define rtDWork                        heli_q8_uint_DW
#define D_Work                         DW_heli_q8_uint_T

/* Parameters (auto storage) */
struct P_heli_q8_uint_T_ {
  real_T A_obsv[36];                   /* Variable: A_obsv
                                        * Referenced by: '<Root>/Gain8'
                                        */
  real_T C_obsv[12];                   /* Variable: C_obsv
  ...
  real_T K[6];                         /* Variable: K
                                        ...
                                        */
  real_T L[12];                        /* Variable: L
                                        * Referenced by: '<Root>/Gain7'
                                        */
  real_T L_2;                          /* Variable: L_2
                                        * Referenced by: '<Root>/Bias'
                                        */
  real_T L_3;                          /* Variable: L_3
                                        * Referenced by: '<Root>/Bias'
                                        */
  ...
  real_T Frontgain_Gain;               /* Expression: 0.5
                                        ...
                                        */
  real_T Constant2_Value;              /* Expression: 311
  ...
  real_T Gain1_Gain_c;                 /* Expression: pi/180
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: -69
...
extern P_heli_q8_uint_T heli_q8_uint_P;

/* Block signals (auto storage) */
extern B_heli_q8_uint_T heli_q8_uint_B;

/* Continuous states (auto storage) */
extern X_heli_q8_uint_T heli_q8_uint_X;

/* Block states (auto storage) */
extern DW_heli_q8_uint_T heli_q8_uint_DW;
...
extern void heli_q8_uint_initialize(void);
extern void heli_q8_uint_output0(void);
extern void heli_q8_uint_update0(void);
extern void heli_q8_uint_output(int_T tid);
extern void heli_q8_uint_update(int_T tid);
extern void heli_q8_uint_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_uint_T *const heli_q8_uint_M;
 ...
 *
 * '<Root>' : 'heli_q8_uint'
 * '<S1>'   : 'heli_q8_uint/Conversion'
 * '<S2>'   : 'heli_q8_uint/Degrees to Radians'
 * '<S3>'   : 'heli_q8_uint/Degrees to Radians1'
 * '<S4>'   : 'heli_q8_uint/Degrees to Radians2'
 * '<S5>'   : 'heli_q8_uint/Degrees to Radians3'
 * '<S6>'   : 'heli_q8_uint/Degrees to Radians4'
 * '<S7>'   : 'heli_q8_uint/Degrees to Radians5'
 * '<S8>'   : 'heli_q8_uint/Elevation controller'
 * '<S9>'   : 'heli_q8_uint/Heli 3D'
 * '<S10>'  : 'heli_q8_uint/Joystick'
 * '<S11>'  : 'heli_q8_uint/Pitch controller'
 * '<S12>'  : 'heli_q8_uint/Elevation controller/Elevation controller'
 * '<S13>'  : 'heli_q8_uint/Heli 3D/Elevation rad to deg'
 * '<S14>'  : 'heli_q8_uint/Heli 3D/Elevation rate rad to deg'
 * '<S15>'  : 'heli_q8_uint/Heli 3D/Pitch rad to deg'
 * '<S16>'  : 'heli_q8_uint/Heli 3D/Pitch rate rad to deg'
 * '<S17>'  : 'heli_q8_uint/Heli 3D/Travel rad to deg'
 * '<S18>'  : 'heli_q8_uint/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_uint_h_ */
