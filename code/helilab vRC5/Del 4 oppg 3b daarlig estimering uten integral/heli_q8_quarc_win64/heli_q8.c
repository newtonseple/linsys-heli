...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      rtb_Gain2 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      rtb_Gain2 = 0.0;
    } else {
      rtb_Gain2 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S7>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * rtb_Gain2 *
     ...
     *  Gain: '<S12>/Gain'
     */
    heli_q8_B.Gain1_m = heli_q8_P.Gain_Gain_a * heli_q8_B.PitchCounttorad *
      heli_q8_P.Gain1_Gain_o;
   ...
   *  Gain: '<S13>/Gain'
   */
  rtb_Gain2 = heli_q8_P.Gain_Gain_ae * heli_q8_B.PitchTransferFcn *
   ...
   */
  for (i = 0; i < 2; i++) {
    heli_q8_B.Sum[i] = heli_q8_B.Gain3[i] - ((heli_q8_P.K[i + 2] * rtb_Gain2 +
      heli_q8_P.K[i] * heli_q8_B.Gain1_m) + heli_q8_P.K[i + 4] * rtb_Gain1);
  }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2554638216U);
  heli_q8_M->Sizes.checksums[1] = (1704108581U);
  heli_q8_M->Sizes.checksums[2] = (28824867U);
  heli_q8_M->Sizes.checksums[3] = (2422120252U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (158);/* Sum of parameter "widths" */
  return heli_q8_M;
}
