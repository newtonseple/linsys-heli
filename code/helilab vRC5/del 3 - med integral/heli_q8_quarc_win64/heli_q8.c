 ...
 * C source code generated on : Thu Oct 20 18:23:16 2016
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* S-Function Block: heli_q8/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_Gain_i = heli_q8_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
     ...
     */
    heli_q8_B.Add2 = rtb_Gain_i + heli_q8_P.Constant2_Value_e;
     ...
     *  Gain: '<S13>/Gain'
     */
    heli_q8_B.Gain1 = heli_q8_P.Gain_Gain * heli_q8_B.ElevationCounttorad *
     ...
     */
    if (heli_q8_B.Gain1 >= heli_q8_P.Switch_Threshold) {
      rtb_Gain_i = heli_q8_P.Constant2_Value;
    } else {
      rtb_Gain_i = heli_q8_P.Constant_Value;
    }
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      rtb_Gain2 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      rtb_Gain2 = 0.0;
    } else {
      rtb_Gain2 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S9>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * rtb_Gain2 *
      heli_q8_P.Joystick_gain_y;

    /* Gain: '<Root>/Gain1' */
    rtb_Gain1 = heli_q8_P.Gain1_Gain_b * heli_q8_B.Joystick_gain_y;

    /* Switch: '<S11>/Switch2' incorporates:
     *  RelationalOperator: '<S11>/LowerRelop1'
     *  Switch: '<Root>/Switch1'
     */
    if (rtb_Gain1 > rtb_Gain_i) {
      heli_q8_B.Switch2 = rtb_Gain_i;
    } else {
      if (heli_q8_B.Gain1 >= heli_q8_P.Switch1_Threshold) {
        /* Switch: '<Root>/Switch1' incorporates:
         *  Constant: '<Root>/Constant1'
         */
        rtb_Switch1 = heli_q8_P.Constant1_Value;
      } else {
        /* Switch: '<Root>/Switch1' incorporates:
         *  Constant: '<Root>/Constant3'
         */
        rtb_Switch1 = heli_q8_P.Constant3_Value;
      }

      /* Switch: '<S11>/Switch' incorporates:
       *  RelationalOperator: '<S11>/UpperRelop'
       */
      if (rtb_Gain1 < rtb_Switch1) {
        heli_q8_B.Switch2 = rtb_Switch1;
      } else {
   ...
   *  Gain: '<S14>/Gain'
   */
  rtb_Gain1 = heli_q8_P.Gain_Gain_n * heli_q8_B.ElevationTransferFcn *
   ...
   */
  heli_q8_B.Sum2 = heli_q8_B.Gain1 - heli_q8_X.Integrator1_CSTATE;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      rtb_Switch1 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      rtb_Switch1 = 0.0;
    } else {
      rtb_Switch1 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S9>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * rtb_Switch1 *
      heli_q8_P.Joystick_gain_x;

    /* Gain: '<Root>/Gain2' */
    rtb_Gain2 = heli_q8_P.Gain2_Gain * heli_q8_B.Joystick_gain_x;

    /* SignalConversion: '<Root>/ConcatBufferAt    In1' */
    heli_q8_B.u_d[0] = rtb_Gain2;
    ...
    /* Gain: '<S15>/Gain' */
    rtb_Gain_i = heli_q8_P.Gain_Gain_a * heli_q8_B.PitchCounttorad;

    /* Gain: '<S2>/Gain1' */
    heli_q8_B.Gain1_m = heli_q8_P.Gain1_Gain_o * rtb_Gain_i;

    /* SignalConversion: '<Root>/ConcatBufferAt    In2' */
    heli_q8_B.u_d[1] = heli_q8_B.Gain1_m;
    ...
    heli_q8_B.Gain3[0] += heli_q8_P.P[0] * rtb_Gain2;
    heli_q8_B.Gain3[0] += heli_q8_P.P[2] * heli_q8_B.Switch2;
    heli_q8_B.Gain3[1] = 0.0;
    heli_q8_B.Gain3[1] += heli_q8_P.P[1] * rtb_Gain2;
    heli_q8_B.Gain3[1] += heli_q8_P.P[3] * heli_q8_B.Switch2;
  }

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate1In1' */
  rtb_VectorConcatenate1[0] = heli_q8_B.Gain1_m;
   ...
   *  Gain: '<S16>/Gain'
   */
  rtb_VectorConcatenate1[1] = heli_q8_P.Gain_Gain_ae *
    heli_q8_B.PitchTransferFcn * heli_q8_P.Gain1_Gain_i;

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate1In3' */
  rtb_VectorConcatenate1[2] = rtb_Gain1;

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate1In4' */
  rtb_VectorConcatenate1[3] = heli_q8_B.Integrator;

  /* SignalConversion: '<Root>/ConcatBufferAtVector Concatenate1In5' */
  ...
  for (i = 0; i < 2; i++) {
    rtb_Switch1 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Switch1 += heli_q8_P.K[(i_0 << 1) + i] * rtb_VectorConcatenate1[i_0];
    }

    heli_q8_B.Sum[i] = heli_q8_B.Gain3[i] - rtb_Switch1;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S5>/Gain1' */
    rtb_Gain1_b = heli_q8_P.Gain1_Gain_bl * rtb_Gain_i;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<Root>/Sum1' */
    heli_q8_B.Sum1 = rtb_Gain1_b - rtb_Gain2;
  }
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (4085398554U);
  heli_q8_M->Sizes.checksums[1] = (1886643194U);
  heli_q8_M->Sizes.checksums[2] = (3653876330U);
  heli_q8_M->Sizes.checksums[3] = (2438919051U);
  ...
  heli_q8_M->Sizes.numBlocks = (97);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (30);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (173);/* Sum of parameter "widths" */
  return heli_q8_M;
}
