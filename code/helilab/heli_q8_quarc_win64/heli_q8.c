...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  heli_q8_B.Gain = (heli_q8_P.TravelTransferFcn_C *
   ...
   *  Sum: '<Root>/Add'
   */
  heli_q8_B.Gain3 = (heli_q8_B.Gain2 - heli_q8_P.Gain4_Gain * heli_q8_B.Gain *
                     heli_q8_P.Gain1_Gain) * heli_q8_P.Krp;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<Root>/Gain1' */
    heli_q8_B.Gain1_f = heli_q8_P.Gain1_Gain_b * heli_q8_B.Joystick_gain_y;
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.u_j + heli_q8_B.Gain1_f) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Gain1_f - heli_q8_B.u_j) * heli_q8_P.Backgain_Gain;
  ...
  rtb_Integrator = heli_q8_X.Integrator_CSTATE;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S9>/K_ei' incorporates:
     *  Sum: '<S5>/Sum'
     */
    heli_q8_B.K_ei = (0.0 - 0.0) * heli_q8_P.K_ei_Gain;
  }
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1421551037U);
  heli_q8_M->Sizes.checksums[1] = (2376100568U);
  heli_q8_M->Sizes.checksums[2] = (1543311300U);
  heli_q8_M->Sizes.checksums[3] = (2057454261U);
  ...
  heli_q8_M->Sizes.numBlocks = (66);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (27);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (157);/* Sum of parameter "widths" */
  return heli_q8_M;
}
